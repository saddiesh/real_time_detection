...
# MODEL_NAMEL_NAME = 'ssd_mobilenet_v1_coco_11_06_2017'
...
def detect_objects(image_np):
    ...
    # Actual detection.
    # TODO: put detection
    boxes, classes, scores = detect_by_maskrcnn(image_np)


    # Visualization of the results of a detection.
    print("scores",scores,np.squeeze(scores))
...
def worker(input_q, output_q):
    ...
    while True:
        ...
        output_q.put(detect_objects(frame_rgb))
...
if __name__ == '__main__':
    ...
    if (args.stream):
        ...
        video_capture = WebcamVideoStream(src="http://admin:admin@10.0.0.97:8081",
                                      width=args.width,
